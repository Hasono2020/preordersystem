...
export default function OrderCreate({ customers }: any) {
    ...
    const itemsTotal = data.items.reduce((sum, i) => sum + (Number(i.quantity) * Number(i.price)), 0);
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <Input type="number" min="0" value={data.total_shipping_fee} onChange={e => setData('total_shipping_fee', Number(e.target.value))} />
                        </div>
                        <div className="space-y-1">
